...
class FNN:
    ...
    def printConfusionMatrix(self, matrix):
        ...
        print("Letters↓", end = "")
        print("TP".rjust(8), "TN".rjust(8), "FP".rjust(8), "FN".rjust(8))
        ...
        for i in range(26):
            ...
            print(str(TP).rjust(8), str(TN).rjust(8), str(FP).rjust(8), str(FN).rjust(8))
...
def test():
    ...
    model = FNN.load("model_1805106.pickle")
    ...
    print("Test result:")
    model.printResult(test_data, test_labels, printConfusionMatrix = True)
