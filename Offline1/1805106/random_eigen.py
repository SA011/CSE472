...
reconstructedMatrix = eigenvectors.dot(np.diag(eigenvalues)).dot(np.linalg.inv(eigenvectors))
...
print ('Reconstructed Matrix is equal to the original matrix. Task 2A end.')
